...
import com.example.hp.smartcafe.Model.Food;
import com.example.hp.smartcafe.ViewHolder.FoodViewHolder;
...
public class FoodList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // materialSearchBar.setSpeechMode(false);
        loadSuggest();// Fundtion to load suggest from firebase
        ...
        foodList.orderByChild("MenuId".equals(categoryId))
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            Food item = postSnapchat.getValue(Food.class);
